// C:\Users\amart\Downloads\MERN_Stack_Project_Ecommerce_Adaa Jaipur\MERN_Stack_Project_Ecommerce_Adaa Jaipur\server\controller\products.js
    ...
    if (
      ...
      try {
        ...
        let newProduct = new productModel({
          ...
          pOffer,
          pStatus,
          pSizeOptions: pSizeOptions || ["S", "M", "L", "XL", "XXL"],
          pAttributes: JSON.parse(pAttributes) || {}, // Parse pAttributes from string to object
        });
  ...
  async postEditProduct(req, res) {
    ...
    if (editImages && editImages.length !== 2) {
      ...
      let editData = {
        ...
        pStatus,
        pSizeOptions: pSizeOptions || ["S", "M", "L", "XL", "XXL"],
        pAttributes: typeof pAttributes === 'string' ? JSON.parse(pAttributes) : pAttributes
      };
      ...
      try {
        ...
        console.log(err);
        return res.json({ error: "Product update failed" });
      }
    }
  }
        ...
        checkReviewRatingExists.pRatingsReviews.map((item) => {
          if (item.user.toString() === uId) {
            ...
            try {
              ...
              return res.json({ error: "Review addition failed" });
            }
          }
        });
      } else {
