...
const ProductDetailsSection = (props) => {
  ...
  const [selectedSize, setSelectedSize] = useState("S"); // Selected size state
            ...
            <div className="my-4 md:my-6">
              ...
              <div className="my-4">
                ...
                <select
                  ...
                  className="border border-gray-300 rounded py-2 px-3 leading-tight focus:outline-none focus:border-blue-500"
                >
                  {sProduct.pSizeOptions.map((size) => (
              ...
              <div className="my-4">
                <h2>Attributes</h2>
                <ul>
                  {Object.entries(sProduct.pAttributes).map(([key, value]) => (
