    ...
    <Fragment>
      <div className="bg-gray-100 min-h-screen p-6">
        <div className="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6">
          <h1 className="text-2xl font-bold text-gray-700 mb-4">All Categories</h1>
          <div className="overflow-auto">
            <table className="table-auto border-collapse border w-full text-sm text-left text-gray-700">
              <thead className="bg-gray-200">
                <tr>
                  <th className="px-4 py-3 border text-sm font-medium">Category</th>
                  <th className="px-4 py-3 border text-sm font-medium">Description</th>
                  <th className="px-4 py-3 border text-sm font-medium">Image</th>
                  <th className="px-4 py-3 border text-sm font-medium">Status</th>
                  <th className="px-4 py-3 border text-sm font-medium">Created At</th>
                  <th className="px-4 py-3 border text-sm font-medium">Updated At</th>
              ...
              <tbody>
                {categories && categories.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan="7"
                      className="text-center text-lg font-semibold py-8 text-gray-500"
                    >
                      No categories found
                    </td>
                  </tr>
          ...
          <div className="text-gray-600 text-sm mt-4">
            Total {categories && categories.length} category{categories.length !== 1 && "ies"} found
          </div>
        </div>
      </div>
    </Fragment>
