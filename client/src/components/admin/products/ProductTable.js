// client\src\components\admin\products\ProductTable.js
  ...
  const editProduct = (product) => {
    dispatch({
      ...
      product: {
        ...
        pAttributes: product.pAttributes || {
          styleCode: "",
          fabricCare: "",
          pattern: "",
          type: "",
  ...
  return (
    <Fragment>
      ...
      <td className="p-2 text-left">
        ...
        <td className="p-2 text-left">
          {product.pDescription && product.pDescription.slice(0, 15)}...
        </td>
        ...
        <td className="p-2 text-center">
          {product.pCategory && product.pCategory.cName 
